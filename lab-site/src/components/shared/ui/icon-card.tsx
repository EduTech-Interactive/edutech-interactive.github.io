...
const IconCard: React.FC<IconCardProps> = ({ icon: Icon, title, description }) => {
  return (
    <div className="flex flex-col items-center justify-center p-6 bg-white/90 rounded-2xl shadow-sm hover:shadow-md hover:bg-[lightgray] transition-shadow duration-300 text-center w-full max-w-sm font-body">
      {/*icon*/}
