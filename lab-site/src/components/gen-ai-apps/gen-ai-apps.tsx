...
import laptopBg from "/img/gen-ai-apps/laptop-bg.webp";
      ...
      >
        ...
        <div className="text-white z-10 space-y-4 md:space-y-6">
          ...
          <p className="font-body text-lg md:text-xl lg:text-2xl text-blue-100/90 leading-relaxed">
            {t("genAiApps.calcBuddy.desc")}
          </p>
          
          {/*btn*/}
          <div className="pt-2">
          <Link to="https://calculus-buddy.intg.eduqlasse.com/" target="_blank">
            <Button>
              {t("genAiApps.calcBuddy.btnText")}
            </Button>
          </Link>
          </div>
